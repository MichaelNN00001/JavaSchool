...
public class StorageService {
    ...
    public void saveReferenceAccountFullName(String account, String fullName) {
        recieverStorage.saveReferenceAccountFullName(account, fullName);
    }

    public String getReferenceAccountFullName(String account) {
        return recieverStorage.getReferenceAccountFullName(account);
    }
    ...
    public Optional<ConfirmData> getConfirmDataFromRecieverStorage(Long waitingTimeSec) {
        ...
        if (recieverStorage.isUncheckedEmpty())
            ...
            if (ids.size() > 0) return Optional.of(new ConfirmData(limitSeconds, ids));
        }
